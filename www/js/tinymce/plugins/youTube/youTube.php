            ...
            <div id="size_controls">
                ...
                <tbody>
                    <tr>
                        ...
                        <input type="text" id="youtube_width" size="2" class="form-control" value="<?php echo($szerokosc);?>" /> px
                        </td>
                    ...
                    <tr>
                        ...
                        <input type="text" id="youtube_height" size="2" class="form-control" value="<?php echo($wysokosc);?>" /> px
                        </td>
                        <td class="form_label extra_opts">
